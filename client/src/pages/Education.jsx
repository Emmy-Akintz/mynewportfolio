        ...
        <div className='mt-12'>
            ...
            <SlideInLeft>
                <div onClick={() => setOption1(!option1)} className="block">
                    <div className="w-[280px] md:w-[400px] lg:w-[700px] p-2 flex justify-between items-center cursor-pointer" style={{ background: theme.ui }}>
                    ...
                    <div className={option1 ? "border p-2 w-[280px] md:w-[400px] lg:w-[700px] mt-1" : "hidden"}>
            ...
            <SlideInRight>
                <div onClick={() => setOption2(!option2)} className="block mt-1">
                    <div className="w-[280px] w-[280px] md:w-[400px] lg:w-[700px] p-2 flex justify-between items-center cursor-pointer" style={{ background: theme.ui }}>
                    ...
                    <div className={option2 ? "block border mt-1 p-2 w-[280px] md:w-[400px] lg:w-[700px]" : "hidden"}>
            ...
            <FadeUp>
                <div onClick={() => setOption3(!option3)} className="block mt-1">
                    ...
                    <div className={option3 ? "block border mt-1 p-2 w-[280px] md:w-[400px] lg:w-[700px]" : "hidden"}>
